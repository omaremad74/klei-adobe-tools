// (Omar): Thank you to this git for providing a proper working jsapi unlike Adobe's docs :) https://github.com/Daniil-SV/Macromedia-jsfl-deobfuscator/blob/main/include/jsapi.h
